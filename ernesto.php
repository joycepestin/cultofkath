    ...
    <body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                <div class="card-body"><p class="text-black m-0"> “Let's just say” and “Let's put it this way.”</p></div>
            </div>
            <!-- Content Row-->
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Abella is a representative of Kabayan party-list group as presidential spokesperson, citing personal reasons.</p>
                        </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Sokolov Award</p>
                        </div>
                        <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">More Info</a></div>
                    </div>
                </div>
